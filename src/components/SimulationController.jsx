    ...
    <div className="pointer-events-none fixed inset-x-0 bottom-5 z-40 flex justify-center px-4">
      <AnimatePresence>
        <motion.div
          ...
          className="pointer-events-auto flex w-full max-w-5xl flex-col gap-3 rounded-2xl border border-cyan-500/40 bg-slate-900/80 p-4 text-sm text-slate-100 shadow-[0_10px_60px_rgba(14,165,233,0.25)] backdrop-blur-md"
        >
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-cyan-500/90 to-sky-400/80 text-slate-950 shadow-neon">
                <Zap size={18} />
              </div>
              <div>
                <p className="text-[11px] uppercase tracking-[0.18em] text-cyan-200">Simulation Mode - For Demonstration</p>
